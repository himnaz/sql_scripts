declare @Q nvarchar(max)
	, @i int=1
	, @BeginTime nvarchar(25)=N'2016-01-19 10:21:50.000'
	, @EndTime nvarchar(25)=N'2016-01-19 10:45:00.000'
while @i <= 4
begin
	...
	SELECT top 5
		...
		and high_io.last_execution_time between '''+@BeginTime+N''' and '''+@EndTime+N'''
